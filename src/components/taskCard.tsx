...
const TaskCard: React.FC<TaskCardProps> = ({
  ...
  return (
    <div 
      className="bg-gray-200 rounded-lg shadow-none p-4 w-80 border border-gray-300 cursor-pointer" 
      onClick={() => onClick(id)} // Handle click instead of <Link>
    >
      {/* Project Name & Title */}
